                    ...
                    {workData.map((project, index) => (
                        <Link href={project.link} target="_blank" key={index} className='group'>
                            <div 
                                ...
                                className='w-[350px] aspect-[16/9] bg-no-repeat bg-cover bg-center relative border rounded-lg cursor-pointer group shadow-md'
                            >
                                <div className='bg-white bg-opacity-90 w-full absolute bottom-0 py-4 px-6 flex justify-between items-center duration-500 group-hover:bottom-2 shadow-lg'>
                                    ...
                                    <div className='border rounded-full border-black w-10 h-10 flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition'>
